<div class="modal fade" id="ver_facturacion" role="dialog" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <form id="form_ver_cotizacion" >
                ...
                <div class="modal-header">
                    ...
                    <h3 class="modal-title text-center"><b>{{ __('Detalles de Facturación') }}</b></h3>
                            ...
                            <div class="card border mb-3" style="max-width: 100rem; {{--border-style:
                                ...
                                <div class="card-header border bg-light" {{--style="border-bottom-style: solid; border-width: 1px;"--}}>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <h4 class="text-right" id="ver_fact_fecha">
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body text-dark">
                                    ...
                                    <div class="row justify-content-end cliente-datos">
                                        <div class="col-md-7">
                                            <div class="text-left">
                                                <h4>
                                                    <b>{{ __('Cliente') }}: </b>
                                                    <text id="ver_fact_cli_nombre"></text>
                                                </h4>
                                                {{--<h6>
                                                    <b>{{ __('Descripción')}}: </b>
                                                    <text id="ver_fact_descripcion"></text>
                                                </h6>--}}
                                                <h6>
                                                    <b>{{ __('Email') }}: </b>
                                                    <text id="ver_fact_cli_email"></text>
                                                </h6>
                                                <h6><b>{{ __('Teléfono') }}: </b>
                                                    <text id="ver_fact_cli_telefono"></text>
                                                </h6>
                                            </div>
                                        ...
                                        <div class="col-md-5">
                                            <div class="text-right">
                                                <h4 class="text-right">
                                                    <text id="ver_fact_info_nombre">{{ $empresa->info_nombre }}</text>
                                                </h4>
                                                <h6 class="text-right">{{ __('Dirección:') }}
                                                    <text id="ver_fact_info_direccion">{{ $empresa->info_direccion }}</text>
                                                </h6>
                                                <h6>{{ __('Teléfono:') }}
                                                    <text id="ver_fact_info_telefono">{{ $empresa->info_telefono }}</text>
                                                </h6>
                                    ...
                                    <div class="table-responsive">
                                        <table id="facturacion_show" class="table table-striped table-no-bordered
                                                        ...
                                                        <table id="tabla_totales" class="table table-striped table-no-bordered
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td id="ver_fact_subtotal">

                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>{{ __('Retención 1%') }}</b></td>
                                                                    <td id="ver_fact_retencion">

                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td><b>{{ __('TOTAL') }}</b></td>
                                                                    <td id="ver_fact_total">
