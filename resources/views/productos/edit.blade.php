@extends('layouts.app', ['activePage' => 'producto', 'titlePage' => __('Editar Producto')])
...
@section('content')
                            ...
                            <div class="card-body ">
                                <div class="row ">
                                    <div class="col-md-5">
                                        <div class="row ">
                                            <div class="col-sm-12">
                                                ...
                                                <input class="form-control{{ $errors->has('prod_codigo') ? ' is-invalid' : '' }}"
                                                       ...
                                                       placeholder="{{ __('Código del producto') }}"
                                                       value="{{old('prod_codigo', $producto->prod_codigo)}}"
                                                       aria-required="true"/>
                                        ...
                                        <div class="row ">
                                            <div class="col-sm-12">
                                                <label for="input-mat_nombre" class="form-label"
                                                       style="padding-top: 20px;margin-bottom: 0px;border-bottom-width: 0;">
                                                    {{ __('Nombre') }}
                                                </label>
                                                <input class="form-control{{ $errors->has('prod_nombre') ? ' is-invalid' : '' }}"
                                                       ...
                                                       value="{{old('prod_nombre', $producto->prod_nombre)}}"
                                                       aria-required="true"/>
                                                <div class="form-group
                                                    {{ $errors->has('prod_codigo') ? ' has-danger' : '' }}"
                                                     style="margin-top: 0px;">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label for="input-mat_cantidad" class="form-label"
                                                       style="padding-top: 20px;margin-bottom: 0px;border-bottom-width: 0;">
                                                    {{ __('Cantidad') }}
                                                </label>
                                                <input class="form-control{{ $errors->has('prod_cantidad') ? ' is-invalid' : '' }}"
                                                       name="prod_cantidad" id="input-mat_cantidad" type="number"
                                                       placeholder="{{ __('Cantidad') }}"
                                                       value="{{old('prod_cantidad', $producto->prod_cantidad)}}"
                                                       aria-required="true"/>
                                                <div class="form-group
                                                    {{ $errors->has('prod_codigo') ? ' has-danger' : '' }}"
                                                     style="margin-top: 0px;">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <input class="form-control{{ $errors->has('prod_precio') ? ' is-invalid' : '' }}"
                                                       name="prod_precio" id="input-prod_precio" type="number"
                                                       placeholder="{{ __('Precio') }}"
                                                       value="{{old('prod_precio', $producto->prod_precio)}}"
                                                       aria-required="true"/>
                                                <div class="form-group
                                                    {{ $errors->has('prod_codigo') ? ' has-danger' : '' }}"
                                                     style="margin-top: 0px;">
                                    ...
                                    <div class="col-md-5">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label for="input-categoria_id" class="form-label"
                                                       style="padding-top: 20px;margin-bottom: 0px;border-bottom-width: 0;padding-bottom: 8px;">
                                                    {{ __('Categoría') }}
                                                </label>
                                                ...
                                                {{ $errors->has('categoria_id') ? ' has-danger' : '' }}"
                                                    ...
                                                    @foreach($categorias as $c)
                                                        <option value="{{$c->id}}"
                                                                ...
                                                                selected
                                                                @elseif($producto->categoria_id == $c->id)
                                                                selected
                                                            @endif>
                                                            {{$c->cat_nombre}}
                                                        </option>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label for="input-prod_descripcion" class="form-label"
                                                       style="padding-top: 20px;margin-bottom: 0px;border-bottom-width: 0;padding-bottom: 8px;">
                                                    {{ __('Presentación') }}
                                                </label>
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        ...
                                                        {{ $errors->has('prod_empaque') ? ' has-danger' : '' }}"
                                                                    ...
                                                                    @foreach($empaques as $e)
                                                                        <option value="{{$e->id}}"
                                                                                @if(old('prod_empaque') == $e->id)
                                                                                selected
                                                                                @elseif($producto->empaque_id == $e->id)
                                                                                selected
                                                                            @endif>
                                                                            {{$e->emp_nombre}}
                                                                        </option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12" >
                                                                <input class="form-control{{ $errors->has('prod_contenido') ? ' is-invalid' : '' }}"
                                                                       ...
                                                                       value="{{old('prod_contenido', $producto->prod_contenido)}}"
                                                                       aria-required="true"/>
                                                                <div class="form-group
                                                                    {{ $errors->has('prod_codigo') ? ' has-danger' : '' }}"
                                                                     style="margin-top: 0px;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            form-control" name="prod_medida" id="input-prod_medida"
                                                                    ...
                                                                    @foreach($medidas as $m)
                                                                        <option value="{{$m->id}}"
                                                                                @if(old('prod_medida') == $m->id)
                                                                                selected
                                                                                @elseif($producto->medida_id == $m->id)
                                                                                selected
                                                                            @endif>
                                        ...
                                        <div class="row ">
                                            <div class="col-sm-12">
                                                ...
                                                <textarea class="form-control{{ $errors->has('prod_descripcion') ? ' is-invalid' : '' }}"
                                                          ...
                                                          aria-required="true">{{old('prod_descripcion', $producto->prod_desc)}}</textarea>
                                                <div class="form-group
                                                    {{ $errors->has('prod_codigo') ? ' has-danger' : '' }}"
                                                     style="margin-top: 0px;">
                                        ...
                                        <div class="row ">
                                            <div class="col-sm-12" >
                                                ...
                                                <textarea class="form-control{{ $errors->has('prod_proced') ? ' is-invalid' : '' }}"
                                                          ...
                                                          aria-required="true">{{old('prod_proced', $producto->prod_procedimiento)}}</textarea>
                                                <div class="form-group
                                                    {{ $errors->has('prod_codigo') ? ' has-danger' : '' }}"
                                                     style="margin-top: 0px;">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card ">
                    ...
                    <form method="POST" action="{{ route('producto.update', $producto->id) }}" autocomplete="off">
                        <div class="card-body ">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="form-group bmd-form-group col-md-12">
                                    ...
                                    <input value="{{ $producto->prod_nombre }}" type="text" class="form-control" id="mat_nombre" name="prod_nombre">
                                </div>
                                <div class="form-group bmd-form-group col-md-6">
                                    <label for="mat_cantidad" class="bmd-label-floating">Cantidad</label>
                                    <input value="{{ $producto->prod_cantidad }}" type="number" class="form-control" id="mat_cantidad" name="prod_cantidad">
                                </div>
                                <div class="form-group bmd-form-group col-md-6">
    ...
    <select class="form-control selectpicker" data-style="btn btn-link" id="" name="categoria_id">
        ...
        @foreach($categorias as $c)
            <option @if($c->id == $producto->categoria_id) selected @endif value="{{ $c->id }}">{{ $c->cat_nombre }}</option>
        @endforeach
    </select>
    </div>
    <div class="form-group bmd-form-group col-md-4">
        <label for="prod_precio" class="bmd-label-floating">Precio</label>
        <input value="{{ $producto->prod_precio }}" pattern="^\d*(\.\d{0,2})?$" class="form-control" id="prod_precio" name="prod_precio">
    </div>
    <div class="form-group bmd-form-group col-md-8">
        <label for="prod_desc" class="bmd-label-floating">Descripción</label>
        <input value="{{ $producto->prod_desc }}" type="text" class="form-control" id="prod_desc" name="prod_desc">
    </div>
    <div class="row px-4 mt-4" style="overflow-y:scroll;max-height:190px;width: 100%;">
        ...
        @foreach($materiales as $m)
            ...
            <div class="form-group bmd-form-group col-md-4">
                ...
                <input value="{{$producto->cantidad($producto->id,$m->id)}}" type="number" class="form-control" id="mat_cantidad_{{ $m->id }}" name="mat_cantidad[]" max="{{ $m->mat_cantidad }}">
            </div>
        @endforeach
    </div>
